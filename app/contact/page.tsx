...
const ContactPage = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-screen bg-[#050505] text-[#ededed] font-sans selection:bg-cyan-400 selection:text-black overflow-hidden flex flex-col"
    >
      {/* --- STYLES & TEXTURE --- */}
      <style jsx global>{`
      ...
      `}</style>
      <div
        className="absolute inset-0 pointer-events-none opacity-[0.04] z-50 fixed mix-blend-overlay"
        style={{
      ...
      <main className="flex-1 flex flex-col justify-center items-center px-6 relative z-10 text-center">
        ...
        {/* MASSIVE EMAIL LINK */}
        <a
          href="mailto:contact@dippal.dev"
          className="reveal group relative inline-block"
        >
        ...
        <div className="reveal mt-16 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24 text-center">
          <div>
            <h3 className="flex items-center justify-center gap-2 font-inter text-zinc-500 uppercase tracking-widest text-xs mb-2">
