...
const AboutPage = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full min-h-screen bg-[#050505] text-[#ededed] font-sans selection:bg-cyan-400 selection:text-black"
    >
      {/* --- STYLES & TEXTURE --- */}
      <style jsx global>{`
      ...
      `}</style>
      <div
        className="inset-0 pointer-events-none opacity-[0.04] z-50 fixed mix-blend-overlay"
        style={{
      ...
      <main className="pt-32 pb-20 px-6 md:px-12 w-full max-w-[1400px] mx-auto flex flex-col md:flex-row gap-16 relative z-10">
        ...
        <div className="w-full md:w-1/2 h-[60vh] md:h-[80vh] relative overflow-hidden group">
          ...
          <div className="absolute bottom-6 left-6 z-20 bg-black/50 backdrop-blur-md px-4 py-2 border border-white/10">
            <p className="font-inter text-xs text-cyan-400 uppercase tracking-widest">
              Dip Pal • Full Stack Dev
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          ...
          <p className="anim-text font-inter text-zinc-300 text-lg leading-relaxed mb-6">
            I am a Full Stack Developer based in Dhaka, obsessed with the
            intersection of{" "}
            <span className="text-white font-bold">performance</span> and{" "}
          ...
          <p className="anim-text font-inter text-zinc-400 text-base leading-relaxed mb-12">
            ...
            which quickly turned into a career building scalable applications
            for Ancova Software. I don&apos;t just write code; I architect
          ...
          <div className="grid grid-cols-2 gap-8 border-t border-white/10 pt-8 mb-12">
            <div className="stat-item">
              <span className="block font-anton text-5xl text-white mb-1">
                02+
              </span>
              <span className="font-inter text-xs text-cyan-400 uppercase tracking-widest">
                Years Experience
              </span>
            </div>
            <div className="stat-item">
